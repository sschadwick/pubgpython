...
async def my_background_task():
    ...
    while not client.is_closed:
        ...
        EmbedPu = discord.Embed(title="Mercado Criptomoedas em {} (UTC)".format(last_updated_btc))
        ...
        EmbedPu.set_footer(text="Developed by: Jacques Jacob with API CoinMarketCap®")
        ...
        await client.send_message(channel, embed=EmbedPu)
